...
export async function register(req, res) {
  try {
    const { firstname, lastname, email, password, confirmPassword, role, image } = req.body;
    ...
    await sendEmail({
      ...
      html: `Bonjour ${firstname},<br><br>Merci de vérifier votre compte en cliquant sur ce lien : <a href="${verificationUrl}">Vérifier mon compte</a><br><br>Ce lien est valable 24h.`,
    });
